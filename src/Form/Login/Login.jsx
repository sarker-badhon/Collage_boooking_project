                ...
                <div className="card flex w-full  shadow-2xl bg-base-100">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <input
                                className="btn bg-blue-950 text-white hover:bg-blue-900 font-bold h-16"
                                type="submit"
                    ...
                    <p className="text-center pb-4 ">
                        New to Campus.booking?
                        <Link className="link text-blue-500" 
                        to="/signUp">
                            Create an Account
                        </Link>
                    </p>
                    <div className="w-96 text-center mb-8">
                        <button  onClick={handleGoogleSignIn} className="btn btn-outline h-16 hover:bg-blue-950 font-bold w-[390px]  ml-10">
